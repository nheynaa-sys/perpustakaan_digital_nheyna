        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-3">
                ...
                <div class="field-wrap">
                    ...
                    <input id="name" type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Masukkan nama lengkap" required autocomplete="name" autofocus>
                </div>
                @error('name')
            ...
            <div class="mb-3">
                ...
                <div class="field-wrap">
                    ...
                    <input id="email" type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="contoh@sekolah.com" required autocomplete="username">
                </div>
                @error('email')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <p class="text-center mt-3">
                Sudah punya akun? <a href="{{ route('login') }}" class="forgot-link">Masuk</a>
            </p>
